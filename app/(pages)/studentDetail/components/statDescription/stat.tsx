...
export default function Stat({ typeStat, nameStat, Level, levelWeapon }: parameterType) {
   ...
   return (
      <div className="w-full flex items-center">
         ...
         <span className="flex-grow overflow-hidden whitespace-nowrap text-ellipsis">{nameStat}</span>
         <span className="ml-5 mr-2 flex-shrink-0">{Math.round(value + equipmentBonus + weaponValue)}</span>
      </div>
   );
}
